...
type Config struct {
	LogLevel    int           `json:",optional,env=DATABASE_LOG_LEVEL,default=2"       envconfig:"DATABASE_LOG_LEVEL"              default:"2"`        // 日志级别
	Driver      string        `json:",optional,env=DATABASE_DRIVER,default=postgres"   envconfig:"DATABASE_DRIVER"                 default:"postgres"` // 驱动
